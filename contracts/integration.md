...
| `governance` | `icd/governance-metadata` | `icd/tenant-context-headers` |
| `security` | — | `icd/tenant-context-headers`、`icd/governance-metadata` |
| `tools-bi` | — | `icd/tenant-context-headers`、`icd/governance-metadata` |
| `privacy` | — | `icd/tenant-context-headers`（Java 编排侧） |
| `data-foundation` | — | `icd/tenant-context-headers`、`icd/governance-metadata` |
| `platform-common` | — | `icd/tenant-context-headers`、`icd/governance-metadata` |
| `control-plane` | — | `icd/tenant-context-headers` |
| `webui` | — | `icd/governance-metadata`（+ 后端 REST OpenAPI 契约，待落地） |
